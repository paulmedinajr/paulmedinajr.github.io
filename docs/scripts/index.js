(() => {
  const baboySequenceImages = [];
  for (let i = 100000; i <= 100359; i ++) {
    baboySequenceImages.push(`${i}.jpg`);
  }
  ...
  */
  ...
  const baboySequence = new ScrollSequence({
    container: '.baboy-sequence',
    scrollWith: '.baboy-container',
    images: baboySequenceImages,
    imagesRoot: '/images/home/sequence/',
